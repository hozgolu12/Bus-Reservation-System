...
export class AdminAPI {
  ...
  static async getAllUsers(token: string, page: number = 1, search?: string) {
    const url = new URL(`${DJANGO_API_URL}/api/admin/users/`);
  ...
  static async blockUser(token: string, userId: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/admin/users/${userId}/block/`, {
      method: 'PATCH',
      headers: this.getHeaders(token),
    });
  ...
  static async unblockUser(token: string, userId: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/admin/users/${userId}/unblock/`, {
      method: 'PATCH',
      headers: this.getHeaders(token),
    });
  ...
  static async getAllOperators(token: string, page: number = 1) {
    const url = new URL(`${DJANGO_API_URL}/api/admin/operators/`);
    url.searchParams.append('page', page.toString());
  ...
  static async createOperator(token: string, operatorData: {
    ...
    const response = await fetch(`${DJANGO_API_URL}/api/admin/operators/`, {
      method: 'POST',
      headers: this.getHeaders(token),
  ...
  static async deleteOperator(token: string, operatorId: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/admin/operators/${operatorId}/`, {
      method: 'DELETE',
      headers: this.getHeaders(token),
    });
  ...
  static async getDashboardStats(token: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/admin/dashboard/stats/`, {
      headers: this.getHeaders(token),
    });
  ...
  static async getAuditLogs(token: string, page: number = 1) {
    const url = new URL(`${DJANGO_API_URL}/api/admin/audit-logs/`);
    url.searchParams.append('page', page.toString());
...
export class OperatorAPI {
  ...
  static async getProfile(token: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/operator/profile/`, {
      headers: this.getHeaders(token),
    });
  ...
  static async deleteAccount(token: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/operator/delete/`, {
      method: 'DELETE',
      headers: this.getHeaders(token),
    });
  ...
  static async getMyBuses(token: string) {
    const response = await fetch(`${NESTJS_API_URL}/api/operator/buses`, {
      headers: this.getHeaders(token),
    });
  ...
  static async updateBus(token: string, busId: string, busData: any) {
    const response = await fetch(`${NESTJS_API_URL}/api/operator/buses/${busId}`, {
      method: 'PUT',
      headers: this.getHeaders(token),
      body: JSON.stringify(busData),
    });
  ...
  static async getMyRoutes(token: string) {
    const response = await fetch(`${NESTJS_API_URL}/api/operator/routes`, {
      headers: this.getHeaders(token),
    });
  ...
  static async updateRoute(token: string, routeId: string, routeData: any) {
    const response = await fetch(`${NESTJS_API_URL}/api/operator/routes/${routeId}`, {
      method: 'PUT',
      headers: this.getHeaders(token),
      body: JSON.stringify(routeData),
    });
  ...
  static async getDashboardStats(token: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/operator/dashboard/stats/`, {
      headers: this.getHeaders(token),
    });
...
export class UserAccountAPI {
  ...
  static async getProfile(token: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/user/profile/`, {
      headers: this.getHeaders(token),
    });
  ...
  static async deleteAccount(token: string) {
    const response = await fetch(`${DJANGO_API_URL}/api/user/delete/`, {
      method: 'DELETE',
      headers: this.getHeaders(token),
    });
  ...
  static async changePassword(token: string, passwordData: {
    ...
    const response = await fetch(`${DJANGO_API_URL}/api/user/change-password/`, {
      method: 'POST',
      headers: this.getHeaders(token),
